...
#ifndef LIBSERIALPOSIX_H
#define LIBSERIALPOSIX_H
 ...
 * 
 * @return Upon success, performing the process of opening the serial port, it returns the serial port structure (`serial_t`) filled.\n
 ...
 *    cfg.timeout = 10;
 *    serial_t * serial = serial_open( "/dev/ttyUSB0", 0, &cfg ); 
 *    if( !serial )
 *      // handle error
 *    // ready to use ...
 * @endcode
 *   Method-2:
 * @code{.c}
 *    serial_t * serial = serial_open( "/dev/ttyUSB0", 0, NULL ); 
 *    if( !serial )
 *      // handle error
 ...
 *   
 **************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
serial_t * serial_open( const char * pathname, uint8_t readonly, const serial_config_t * config );
 ...
 *  
 **************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
int8_t serial_flush( const serial_t * serial, uint8_t option );
 ...
 *  
**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
char * serial_print( uint8_t out, const serial_t * serial );
